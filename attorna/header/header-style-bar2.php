<?php
	...
	$header_style = attorna_get_option('general', 'header-bar2-navigation-align', 'center');
...
?>	
<header class="attorna-header-wrap attorna-header-style-bar attorna-style-2 <?php echo esc_attr($header_wrap_class); ?>" >
	...
	<div class="attorna-header-container clearfix <?php echo esc_attr($header_container_class); ?>">
		...
		<?php
			...
			if( !empty($logo_right_button_text) && !empty($logo_right_button_link) ){
				$logo_right_text .= '<a class="attorna-logo-right-button" ';
	...
	<div class="attorna-navigation-bar-wrap attorna-navigation-header-style-bar attorna-style-2 <?php echo esc_attr($navigation_wrap_class); ?>" >
